...
import com.aradipatrik.local.database.common.CategoryConstants.WALLET_ID_COLUMN_NAME
...
interface CategoryDao {
    companion object Queries {
        ...
        const val GET_PENDING_CATEGORIES =
        ...
        const val GET_ALL_CATEGORIES_INSIDE_WALLET = "SELECT * FROM $TABLE_NAME " +
    ...
    @Query(GET_ALL_CATEGORIES_INSIDE_WALLET)
    fun getCategoriesInsideWallet(walletId: String): Observable<List<CategoryRow>>
}

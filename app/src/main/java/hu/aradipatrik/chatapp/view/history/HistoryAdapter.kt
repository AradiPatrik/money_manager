...
import hu.aradipatrik.chatapp.databinding.ListItemHistoryHeaderBinding
import hu.aradipatrik.chatapp.databinding.ListItemHistoryTransactionBinding
import hu.aradipatrik.chatapp.util.isSameDay
import hu.aradipatrik.chatapp.view.history.HistoryItem.Companion.HEADER_TYPE_ID
import hu.aradipatrik.chatapp.view.history.HistoryItem.Companion.TRANSACTION_TYPE_ID
...
sealed class HistoryItem(val typeId: Int) {
    ...
    object DiffCallback : DiffUtil.ItemCallback<HistoryItem>() {
        ...
        override fun areContentsTheSame(oldItem: HistoryItem, newItem: HistoryItem) =
            when {
                oldItem is HeaderItem && newItem is HeaderItem -> areItemsTheSame(oldItem, newItem)
                oldItem is TransactionItem && newItem is TransactionItem ->
